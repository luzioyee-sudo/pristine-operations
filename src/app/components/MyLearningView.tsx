  ...
  return (
    <div className="max-w-5xl mx-auto w-full pb-20 px-4 sm:px-6">
      <div className="mb-8 pt-4">
        <h1 className="text-3xl font-black text-[#21222D] dark:text-[#DBDBE5] tracking-tight mb-2 flex items-center gap-3">
          <LayoutDashboard className="w-8 h-8 text-[#1856B7] dark:text-[#ACD1FD]" />
          My Learning Dashboard
        </h1>
        <p className="text-[#545565] dark:text-[#DBDBE5] text-base font-medium">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-white dark:bg-[#2C2C2E] rounded-3xl p-6 border border-[#E6DFD3] dark:border-[#21222D] shadow-xs flex flex-col items-center text-center">
           ...
           <span className="text-4xl font-black text-[#21222D] dark:text-[#DBDBE5] mb-1">{aggregatedStats.maxStreak}</span>
        ...
        <div className="bg-white dark:bg-[#2C2C2E] rounded-3xl p-6 border border-[#E6DFD3] dark:border-[#21222D] shadow-xs flex flex-col items-center text-center">
           ...
           <span className="text-4xl font-black text-[#21222D] dark:text-[#DBDBE5] mb-1">{aggregatedStats.totalVocab}</span>
        ...
        <div className="bg-white dark:bg-[#2C2C2E] rounded-3xl p-6 border border-[#E6DFD3] dark:border-[#21222D] shadow-xs flex flex-col items-center text-center">
           ...
           <span className="text-4xl font-black text-[#21222D] dark:text-[#DBDBE5] mb-1">{aggregatedStats.totalDocs}</span>
           <span className="text-[#545565] dark:text-[#A1A1AA] text-sm font-bold uppercase tracking-wider">Total Books Read</span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between mb-6 border-b border-[#E6DFD3] dark:border-[#21222D] pb-2">
        ...
        <span className="text-xs font-semibold text-[#545565] dark:text-stone-400">
            ...
            <div className="flex items-center gap-4">
               ...
               <div>
                 <div className="flex items-center gap-2">
                   <h3 className="text-base font-bold text-[#21222D] dark:text-[#DBDBE5]">{langName}</h3>
                 ...
                 <p className="text-xs text-[#545565] dark:text-[#A1A1AA] mt-0.5 flex items-center gap-1">
