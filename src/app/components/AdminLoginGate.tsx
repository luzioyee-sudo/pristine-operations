  ...
  return (
    <div className="min-h-[100dvh] w-full bg-[#F6F5F2] dark:bg-[#0D0F0B] flex items-center justify-center p-4 sm:p-6 md:p-8 overflow-y-auto">
      <motion.div
        ...
        className="w-full max-w-sm sm:max-w-md bg-white dark:bg-[#151813] border border-[#DBDBE5] dark:border-stone-800 rounded-3xl p-6 sm:p-8 shadow-xl relative overflow-hidden my-auto"
      >
        {/* Sleek top ambient light */}
        <div className="absolute top-0 inset-x-0 h-1.5 bg-gradient-to-r from-amber-500 via-[#958CE8] to-amber-600" />
        ...
        <div className="mt-8 flex flex-col items-center text-center">
          <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-amber-50 dark:bg-amber-950/30 flex items-center justify-center border border-amber-200/50 dark:border-amber-900/40 text-[#958CE8] dark:text-amber-400 mb-4 sm:mb-5 shadow-2xs">
            <Lock className="w-7 h-7 sm:w-8 sm:h-8" />
          </div>
          <h1 className="text-xl sm:text-2xl font-black text-[#21222D] dark:text-stone-50 tracking-tight">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                autoFocus
                className="w-full ps-10 pe-11 py-3.5 rounded-2xl border border-[#DBDBE5] dark:border-stone-800 bg-[#DBDBE5] dark:bg-stone-900 text-sm text-[#21222D] dark:text-stone-100 focus:outline-none focus:border-[#958CE8] focus:ring-2 focus:ring-[#958CE8]/30 transition-all min-h-[48px]"
              />
              <button
                type="button"
        ...
        {/* Security Tip */}
        <div className="mt-6 sm:mt-8 pt-5 border-t border-[#DBDBE5]/60 dark:border-stone-800/60 flex flex-col items-center text-center gap-1.5">
          <div className="flex items-center gap-1 text-[11px] text-stone-400 dark:text-stone-500 font-medium">
            ...
            <span className="text-[#958CE8] dark:text-amber-400 font-bold bg-amber-500/10 px-2 py-0.5 rounded-md font-mono">admin123</span>
          </div>
        </div>
      </motion.div>
    </div>
