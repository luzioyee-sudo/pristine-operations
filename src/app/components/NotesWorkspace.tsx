  ...
  const handleAiSummarizePage = async () => {
    ...
    try {
      ...
      if (data && data.explanation) {
        const summaryHtml = `<div style="background-color: rgba(174, 91, 52, 0.08); padding: 12px; border-radius: 12px; margin-bottom: 12px; border-left: 4px solid #958CE8;"><h4><strong>✨ AI Page ${currentPage} Insight:</strong></h4><p>${data.explanation}</p></div><br/>`;
        if (editorRef.current) {
    ...
    >
      ...
      <div className="flex items-center justify-between px-3 py-1.5 border-b border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md rounded-t-3xl gap-2 text-xs">
        ...
        <div className="flex items-center gap-1">
          ...
          >
            <Settings className="w-3 h-3 text-[#958CE8] dark:text-emerald-400" />
      ...
      <div id="typing-toolbar" className="flex items-center justify-between gap-2 px-3 py-1.5 border-b border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 overflow-x-auto no-scrollbar text-xs">
        ...
        <div className="flex items-center gap-0.5 shrink-0">
          ...
          <div className="flex items-center gap-1" title="Text Color">
            ...
            {['#958CE8', '#A68A64', '#D67D6D', '#2B6CB0', '#2F855A', '#805AD5', '#1E2019'].map((color) => (
              <button
                key={color}
                onMouseDown={(e) => e.preventDefault()}
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          {currentPageText && (
            <button
              ...
              className="px-2.5 py-1 rounded-xl bg-[#958CE8] hover:bg-[#21222D] text-white text-[11px] font-bold flex items-center gap-1 shadow-2xs transition-all disabled:opacity-50 cursor-pointer"
        ...
        {showSettingsModal && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-[#1A1D16] border border-[#DBDBE5] dark:border-stone-800 rounded-3xl p-6 max-w-lg w-full shadow-2xl space-y-6 text-[#21222D] dark:text-stone-100 max-h-[90vh] overflow-y-auto"
            >
              
              {/* Modal Header */}
              <div className="flex items-center justify-between pb-4 border-b border-[#DBDBE5] dark:border-stone-800">
                <div className="flex items-center gap-2">
                  <Sliders className="w-5 h-5 text-[#958CE8]" />
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {[
                  { id: 'cream', name: 'Cream Paper', bg: 'bg-[#FCFBF9]', text: 'text-[#21222D]' },
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-2xl border text-xs font-bold text-center transition-all flex items-center justify-between cursor-pointer ${t.bg} ${t.text} ${
                      settings.paperTheme === t.id ? 'ring-2 ring-[#958CE8] border-transparent scale-105' : 'border-[#DBDBE5]'
                    }`}
                  >
                    <span>{t.name}</span>
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-2xl border text-start transition-all cursor-pointer ${
                      settings.fontFamily === f.id
                        ? 'bg-[#958CE8] text-white border-transparent'
                        : 'bg-[#DBDBE5] dark:bg-stone-800/50 border-[#DBDBE5] dark:border-stone-700'
                    }`}
                  >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full accent-[#958CE8] cursor-pointer"
                />
              </div>
                  ...
                  {['compact', 'normal', 'spacious'].map((p) => (
                    <button
                      ...
                      className={`flex-1 py-1 rounded-xl text-xs font-bold capitalize transition-all cursor-pointer ${
                        settings.paddingSize === p ? 'bg-[#958CE8] text-white' : 'text-[#5D7BBE] dark:text-stone-300'
                      }`}
                    >
                      {p}
                    </button>
                  ...
                  <div className="flex items-center gap-1 bg-stone-100 dark:bg-stone-800 p-1 rounded-2xl">
                    <button
                      ...
                      className={`flex-1 py-1 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1 cursor-pointer ${
                        layoutMode === 'split' ? 'bg-[#958CE8] text-white' : 'text-[#5D7BBE] dark:text-stone-300'
                      }`}
                    >
                    ...
                    <button
                      onClick={() => onChangeLayoutMode('stacked')}
                      className={`flex-1 py-1 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1 cursor-pointer ${
                        layoutMode === 'stacked' ? 'bg-[#958CE8] text-white' : 'text-[#5D7BBE] dark:text-stone-300'
                      }`}
                    >
            ...
            <div className="pt-2 border-t border-[#DBDBE5] dark:border-stone-800 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  className="w-4 h-4 accent-[#958CE8] rounded cursor-pointer"
                />
              </div>
            ...
            <button
              onClick={() => setShowSettingsModal(false)}
              className="w-full py-3 rounded-2xl bg-[#958CE8] hover:bg-[#21222D] text-white font-bold text-sm shadow-md transition-all cursor-pointer"
            >
